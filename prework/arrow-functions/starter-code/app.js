...
let sumOnOneLine = (a, b, c, d) => `${a + b + c + d}`;

console.log('Add as a one-line:', sumOnOneLine(1, 2, 3, 4));
...
let newObjectLit = obj => ({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
});

console.log('the new object function:', newObjectLit());
...
console.log('new array:', newSumAndProduct(3, 9));
...
console.log('new message:',newMessage('Allie'));
